...
<style>
    ...
    font-family: 'Poppins', sans-serif;">
        ...
        <table class="table-detail">
            ...
            <tbody>
                <tr class="row-table-data">
                    ...
                    <td style="background-color: #fafafa;">{{ $fecha_pedido }}</td>
                </tr>
            </tbody>
        </table>
        <div class="subcontainer">
        ...
        <table class="table-detail">
            ...
            <tbody>
                <tr class="row-table-data">
                    <td  style="background-color: #fafafa;">{{ $documento }}</td>
                    <td  style="background-color: #fafafa;">{{ $cliente }}</td>
                </tr>
            </tbody>
        </table>
        <table class="table-detail">
            ...
            <tbody>
                <tr class="row-table-data">
                    <td  style="background-color: #fafafa;">{{ $telefono }}</td>
                    <td  style="background-color: #fafafa;">{{ $receiver }}</td>
                </tr>
            </tbody>
        </table>
        @if ($direccion)
        <table class="table-detail">
            ...
            <tbody>
                <tr class="row-table-data">
                    <td  style="background-color: #fafafa;">{{ $direccion }}</td>
                </tr>
            </tbody>
        </table>
        @endif
        <div class="subcontainer">
            <p class="subtitle text">Información de pago</p>
        </div>
        <table class="table-detail">
            <thead>
                <tr class="row-table">
            ...
            <tbody>
                <tr class="row-table-data">
                    ...
                    <td  style="background-color: #fafafa;">{{ $tarjeta }}</td>
                </tr>
            </tbody>
        </table>
        <table class="table-detail">
            ...
            <tbody>
                <tr class="row-table-data">
                    <td  style="background-color: #fafafa;">{{ $montoPago }}</td>
                </tr>
            </tbody>
        </table>
        <div class="subcontainer">
