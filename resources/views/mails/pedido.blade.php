...
<body>
    <div style="
        ...
        <div style="text-align: center;padding: 20px 0px;">
            ...
            <h4 style="margin-top: 40px;">REALIZA TU TRANSFERENCIA SEGÚN ESTAS INDICACIONES</h4>
            <p style="color: #505050;text-align: center;font-weight: 500;">No olvides referenciar tu número de pedido
                <strong>( {{ $params->nro_pedido }} )</strong> en la tranferencia.
            </p>
            <img src="https://cclam.org.pe/recursos.base/public/storage/instruccionpago.jpeg" style="width: 600px;">
        </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr style="font-size: 14px;">
                                                            <td style="display: flex;text-align: center;">
                                                                ...
                                                                <div
                                                                    style="width: 50%;border: solid 1px white;padding: 5px;">
                                                                    <span style="display: block;">{{ $params->nro_pedido }}</span>
                                                                    <span style="font-size: 14px;">
                                                                        (Referencia este número en la
                                                                        transacción)</span>
                                                                </div>
                                                                <div
                                                                    style="width: 50%;display: flex;justify-content: center;align-items: center;border: solid 1px white;padding: 5px;">
                                                        ...
                                                        <tr style="font-size: 14px;">
                                                            <td style="display: flex;text-align: center;">
                                                                <div
                                                                    style="width: 30%;border: solid 1px white;padding: 5px;">
                                                                    <span style="display: block;">{{ $params->documento }}</span>
                                                                </div>
                                                                <div
                                                                    style="width: 70%;display: flex;justify-content: center;align-items: center;border: solid 1px white;padding: 5px;">
                                                        ...
                                                        <tr style="font-size: 14px;">
                                                            <td style="display: flex;text-align: center;">
                                                                <div
                                                                    style="width: 100%;border: solid 1px white;padding: 5px;">
